...
opm alpha bundle build -d deploy/olm-catalog/openstack-cluster/$BUNDLE_VERSION/ --package openstack-cluster --channels beta --default beta --tag $IMAGE_REGISTRY/$PROJECT/openstack-cluster-bundle:v$BUNDLE_VERSION -b buildah
